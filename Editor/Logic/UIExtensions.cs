...
namespace UISystem.Logic
{
    public static class UIExtensions
    {
        ...
        {
            var scrollPos = GetHorizontalNormalizedPosition(scrollRect, target);
            scrollRect.horizontalNormalizedPosition = Mathf.Clamp(scrollPos, 0f, 1f);
        }

        public static Sequence ScrollToCenterSmoothly(this ScrollRect scrollRect, RectTransform target, float duration)
        {
            var scrollPos = GetHorizontalNormalizedPosition(scrollRect, target);
        ...
        private static float GetHorizontalNormalizedPosition(ScrollRect scrollRect, RectTransform target)
        {
        ...
        public static Vector3 Vector3FromFloat(float value) => new Vector3(value, value, value);
    }
}